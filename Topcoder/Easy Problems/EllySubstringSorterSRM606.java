...
5)  "AAAWDIUAOIWDESBEAIWODJAWDBPOAWDUISAWDOOPAWD"
21
...
public class EllysSubstringSorter {
    static String getMin(String S,int L) {
        String sortedString="";
        String processSubString = S.substring(0,L);

        //now sort this substring
        ArrayList<Character> al = new ArrayList<Character>();
        for(int i=0; i<processSubString.length(); i++) {
            al.add(processSubString.charAt(i));
        }
        Collections.sort(al);
        Object[] o = al.toArray();
        ...
        sortedString+=S.substring(L);
        return sortedString;
    }

    public static void main(String[] args) {
        System.out.println(getMin("ABRACADABRA",5));
        System.out.println(getMin("BAZINGA",6));
        System.out.println(getMin("TOPCODER",4));
        System.out.println(getMin("AAAWDIUAOIWDESBEAIWODJAWDBPOAWDUISAWDOOPAWD",21));
    }
}
